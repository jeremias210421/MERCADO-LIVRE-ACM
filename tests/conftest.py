...
_mock_select.in_.return_value = _mock_select
_mock_select.range.return_value = _mock_select
_mock_select.or_.return_value = _mock_select
...
_global_patches = [
    patch(
        "app.services.dashboard_service.get_supabase",
        return_value=_mock_supabase_client,
    ),
    patch(
        "app.services.entregador_service.get_supabase",
        return_value=_mock_supabase_client,
    ),
    patch(
        "app.services.galpao_service.get_supabase", return_value=_mock_supabase_client
    ),
    patch(
        "app.services.pendentes_service.get_supabase",
        return_value=_mock_supabase_client,
    ),
    patch("app.services.rota_service.get_supabase", return_value=_mock_supabase_client),
    patch(
        "app.services.upload_service.get_supabase", return_value=_mock_supabase_client
    ),
...
def mock_supabase():
    ...
    # Um teste setou table.side_effect e vazou p/ os seguintes: sempre limpar
